...
import type { CategoryOption } from '@/components/features/workspace/category-helpers';
      ...
      <CardContent className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="space-y-3">
          <div className="rounded-md border border-border-subtle bg-bg-soft p-4">
            ...
            <pre className="max-h-80 overflow-auto whitespace-pre-wrap break-words rounded-md border border-border-subtle bg-primary p-3 text-xs leading-6 text-primary-foreground">
...
function ApiSpecAICreateDialogContent({
  ...
  const [useWorkspaceConventions, setUseWorkspaceConventions] = useState(true);
      ...
      const result = await onCreateDraft(
        {
          ...
          use_workspace_conventions: useWorkspaceConventions,
          lang,
        },
        {
  ...
  return (
    ...
    >
      ...
      <DialogBody className="space-y-4 px-6 py-5">
        ...
        <div className="space-y-3 rounded-md border border-border-subtle bg-bg-canvas p-4">
          <div>
          ...
          <details
            className="rounded-md border border-border-subtle bg-bg-soft px-4 py-3"
          ...
          >
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2 flex items-center justify-between rounded-md border border-border-subtle bg-bg-canvas px-4 py-3">
                <div className="space-y-1">
                  <div className="text-sm font-medium">
                    {t('apiSpecs.aiCreateDialog.fields.useWorkspaceConventions')}
                  </div>
                  <div className="text-xs text-muted-foreground">
                    {t('apiSpecs.aiCreateDialog.fields.useWorkspaceConventionsDescription')}
                  </div>
                </div>
                <Switch
                  checked={useWorkspaceConventions}
                  onCheckedChange={setUseWorkspaceConventions}
                />
              </div>
            </div>
          </details>
        ...
        {hasPreviewPanel ? (
          <details
            className="rounded-md border border-border-subtle bg-bg-canvas"
            open={showPreview}
            ...
            <Card className="border-border-subtle bg-bg-canvas">
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-center justify-between rounded-md border border-border-subtle bg-bg-soft px-4 py-3">
                    <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="border-t border-border-subtle">
                  ...
                  <div className="space-y-2">
                    <div className="font-medium">
                      {t('apiSpecs.aiCreateDialog.review.workspaceConventions')}
                    </div>
                    {draft.conventions ? (
                      ...
                      <div className="text-muted-foreground">
                        {t('apiSpecs.aiCreateDialog.review.workspaceConventionsDisabled')}
                      </div>
                    )}
                  </div>
      ...
      <DialogFooter className="justify-between gap-3 border-t border-border-subtle px-6 py-4">
