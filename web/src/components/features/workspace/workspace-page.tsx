...
const buildModuleHref = (
  ...
  const baseRoute = buildWorkspaceRoute(workspaceId, module);
  ...
  return (
    <WorkspaceFrame
      sidebar={
        ...
        >
          <ResourceListItem
            href={buildWorkspaceRoute(workspaceId, 'keys')}
            active
                ...
                <Card className="border-border-subtle">
                  ...
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    ...
                    <DetailField label={t('common.workspaceId')}>
                      {selectedCategory.workspace_id ?? selectedCategory.workspace_id}
                    </DetailField>
                  </CardContent>
                </Card>
              ...
              <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
                <Card className="border-border-subtle">
                  ...
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    ...
                    <DetailField label={t('common.workspaceId')}>
                      {selectedHistory.workspace_id ?? selectedHistory.workspace_id}
                    </DetailField>
