...
const messages: ProjectMessages = {
  ...
  common: {
    ...
    backToWorkspaceDashboard: 'Back to workspaces',
    actions: 'Actions',
    status: 'Status',
    duration: 'Duration',
    headers: 'Headers',
  ...
  workspaceDashboard: {
    title: 'Workspaces',
    description:
      'Workspaces are the only top-level collaboration unit. Enter API Specs, Requests, environments, flows, and tests from here.',
    createWorkspace: 'Create workspace',
    loadFailedTitle: 'Failed to load workspaces',
    loadFailedDescription: 'Unable to load the workspace list right now. Try again shortly.',
    emptyTitle: 'No workspaces yet',
    emptyDescription:
      'Create your first workspace to start managing API specs, requests, environments, and test assets.',
    typeLabel: 'Type',
    visibilityLabel: 'Visibility',
    noWorkspaceDescription: 'No description was added for this workspace yet.',
    openWorkspace: 'Open workspace',
    nameRequired: 'Workspace name is required.',
    slugRequired: 'Workspace slug is required.',
    createDialogTitle: 'Create workspace',
    createDialogDescription:
      'Create a new workspace as the single home for API specs, environments, requests, and test assets.',
    namePlaceholder: 'Payments Workspace',
    slugLabel: 'Slug',
    slugPlaceholder: 'paymentsworkspace',
    descriptionPlaceholder:
      'Optional. Add the scope, purpose, or collaboration notes for this workspace.',
    type: {
      personal: 'Personal',
      team: 'Team',
      public: 'Public',
    ...
    loadWorkspaceFailedTitle: 'Failed to load workspace',
    loadWorkspaceFailedDescription: 'Unable to load this workspace right now. Try again shortly.',
    routeReadyTitle: 'Workspace module is ready',
    routeReadyDescription: 'This module is already routed and scoped through workspace-only paths.',
    loadingWorkspace: 'Loading workspace...',
    nextStageTitle: 'Next stage',
    nextStageDescription: 'Continue wiring the remaining workspace-only data flow and interactions.',
    workspaceSnapshotTitle: 'Workspace snapshot',
    workspaceSnapshotDescription: 'Basic context and metadata for the current workspace.',
    loadingBadge: 'Loading',
    returnToDefaultModule: 'Return to API Specs',
  },
  roles: {
    owner: 'Owner',
    admin: 'Admin',
