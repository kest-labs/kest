...
const messages: ProjectMessages = {
  ...
  toasts: {
    projectCreated: 'Created workspace "{name}"',
    projectUpdated: 'Updated workspace "{name}"',
    projectDeleted: 'Workspace deleted',
  ...
  projectForm: {
    ...
    projectNameRequired: 'Workspace name is required.',
  ...
  membersPage: {
    ...
    inviteAccessRequiredDescription:
      'Only admin or owner members can review, create, copy, and revoke project invitations.',
    ...
    noInviteLinks: 'No invitations have been created for this project yet.',
    ...
    addMemberDialogDescription:
      'Search existing users, then send them a direct project invitation with an assignable role.',
  ...
  dashboardPage: {
    ...
    teamOwnerBadge: 'Workspace owner',
    projectCount: '{count} workspaces',
    ...
    importProject: 'Import Workspace',
    nextAction: 'Next action',
    projectSummary: '{count} workspaces. Click a card to enter its workspace.',
    filteredProjectSummary: 'Showing {visible} of {total} workspaces.',
    noProjectsMatchedTitle: 'No matching workspaces',
    searchPlaceholder: 'Search workspaces',
    projectsLabel: 'Workspaces',
    openProjectActions: 'Open workspace actions for {name}',
    ...
    noProjectsMatched: 'No workspaces match the current search keyword.',
    selected: 'Selected',
    ...
    createFirstProjectTitle: 'Create the first workspace',
    ...
    noProjectsYetTitle: 'No workspaces yet',
    noProjectsYetDescription:
      'Use the create action to seed the dashboard with your first workspace.',
    demoProjectCreateFailed: 'Failed to create the demo workspace. Please retry.',
  ...
  commandPalette: {
    ...
    createProject: 'Create workspace',
    createProjectDescription: 'Open the create-workspace dialog',
  ...
  onboardingTour: {
    ...
    steps: {
      ...
      createProjectTitle: 'Creating a workspace is the first move',
  ...
  projectDetail: {
    ...
    projectFlowProgress: '{percent}% Complete · {completed}/{total}',
    loading: 'Loading',
    ready: 'Ready',
    missing: 'Missing',
    available: 'Available',
