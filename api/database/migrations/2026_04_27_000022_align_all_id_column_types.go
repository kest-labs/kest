...
func (m *alignAllIDColumnTypes) Up(db *gorm.DB) error {
	...
	expectations := []idColumnExpectation{
		...
		{table: "api_specs", column: "workspace_id", expectedType: idTypeText},
		...
		{table: "api_spec_shares", column: "workspace_id", expectedType: idTypeText},
		...
		{table: "api_spec_ai_drafts", column: "workspace_id", expectedType: idTypeText},
		...
		// User, role, permission and workspace models also use string IDs.
		// Fresh PostgreSQL installs receive UUIDs from the global string-ID
		// create hook before this migration runs, so these columns must stay
		// text-compatible instead of being coerced to bigint.
		{table: "users", column: "id", expectedType: idTypeText},
		{table: "roles", column: "id", expectedType: idTypeText},
		{table: "permissions", column: "id", expectedType: idTypeText},
		{table: "role_permissions", column: "id", expectedType: idTypeText},
		{table: "role_permissions", column: "role_id", expectedType: idTypeText},
		{table: "role_permissions", column: "permission_id", expectedType: idTypeText},
		{table: "user_roles", column: "id", expectedType: idTypeText},
		{table: "user_roles", column: "user_id", expectedType: idTypeText},
		{table: "user_roles", column: "role_id", expectedType: idTypeText},
		{table: "project_members", column: "user_id", expectedType: idTypeText},
		{table: "api_flows", column: "created_by", expectedType: idTypeText},
		{table: "api_flow_runs", column: "triggered_by", expectedType: idTypeText},
		{table: "history", column: "user_id", expectedType: idTypeText},
		{table: "test_cases", column: "created_by", expectedType: idTypeText},
		{table: "project_cli_tokens", column: "created_by", expectedType: idTypeText},
		{table: "api_spec_shares", column: "created_by", expectedType: idTypeText},
		{table: "api_spec_ai_drafts", column: "created_by", expectedType: idTypeText},
		{table: "project_invitations", column: "created_by", expectedType: idTypeText},
		{table: "audit_logs", column: "user_id", expectedType: idTypeText},
		{table: "workspaces", column: "id", expectedType: idTypeText},
		{table: "workspaces", column: "owner_id", expectedType: idTypeText},
		{table: "workspace_members", column: "id", expectedType: idTypeText},
		{table: "workspace_members", column: "workspace_id", expectedType: idTypeText},
		{table: "workspace_members", column: "user_id", expectedType: idTypeText},
		{table: "workspace_members", column: "invited_by", expectedType: idTypeText},
	}
